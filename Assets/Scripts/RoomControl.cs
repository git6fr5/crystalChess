...
public class RoomControl : MonoBehaviourPunCallbacks //IInRoomCallbacks
{
    ...
    void Start()
    {
        if (PhotonNetwork.IsMasterClient)
        {
            ...
            PhotonNetwork.Instantiate("Board", new Vector3(5, 0, 0), new Quaternion(0f, 0f, 0f, 0f));
            PhotonNetwork.Instantiate("Board", new Vector3(5, 0, 0), new Quaternion(0f, 0f, 0f, 0f));
            PhotonNetwork.Instantiate("ControlPanel", new Vector3(5, 0, 0), new Quaternion(0f, 0f, 0f, 0f));
